...
class ViewController: UIViewController {
    ...
    private var displayingPhotos1 = Array<UIImage?>()
    private var displayingPhotos2 = Array<UIImage?>()
    private var displayingPhotos3 = Array<UIImage?>()
    private var displayingPhotos4 = Array<UIImage?>()
    private var collectionViews = Array<UICollectionView>()
